...
( function() {
	window.getControlLayers = function() {
		...
		const layers = {
			'Street (Wikimedia)': tiles.wikimedia,
	...
	window.getMapTileSets = function() {
		const tiles = [];
		tiles.wikimedia = L.tileLayer(
			'https://maps.wikimedia.org/osm-intl/{z}/{x}/{y}{r}.png',
			{
				attribution:
					'<a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> | <a href="https://wikimediafoundation.org/wiki/Maps_Terms_of_Use">Wikimedia</a>',
				retina: L.Browser.retina ? '@2x' : '',
				minZoom: 1,
				maxZoom: 19,
				placepress_key: 'wikimedia',
			}
		);
