...
function placepress_init() {
	...
	if(placepress_setting('disable_tours')==false){
		...
		register_post_type('tours',
			...
			'description' => __('Collections of location-based locations.','wp_placepress'),
			'public' => true,
			'show_ui' => true,
			'show_in_menu' => true,
	...
	register_post_type('locations',
		...
		'has_archive' => true,
		'supports' => array('title','editor','thumbnail','author','excerpt','comments','revisions','custom-fields'),
		'taxonomies' => array('post_tag','location_subjects'),
	...
	register_taxonomy('location_subjects',
		'locations',
		array(
			'hierarchical' => true,
			...
			'labels' => array(
				...
				'not_found' => __('No Location Subjects Found','wp_placepress'),
