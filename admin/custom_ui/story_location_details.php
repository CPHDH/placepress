...
<script>
	...
	var message_no_results='<?php echo esc_html__('No Results Found','wp_placepress');?>';
	var message_generic_error='<?php echo esc_html__('Something went wrong! Please try again.','wp_placepress');?>';
	var default_coords=<?php echo placepress_setting('default_coordinates');?>;
	var default_zoom=parseInt(<?php echo placepress_setting('default_zoom');?>);
